...
\center
  ...
  {\fontsize{10pt}{\baselineskip}\selectfont
    Fonte: \citeonline{alguem2022nada}}
\end{table}
...
\begin{figure}[H] %Figuras da aula pratica 1.1
  ...
  %\caption{Resultado da atividade prática 1.2, \cite{oliveira_SO2009}}
  \label{fig:ap1_cod_vigual1}
  %Deixar um espaço

  \raggedright{\fontsize{10pt}{\baselineskip}\selectfont Fonte: \citeonline{oliveira_SO2009}}

\end{figure}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Seção que será apagada}
