...
% Local e ano:
\def \local {Maravilha-SC}\def \ano {2022
}

% Nota explicativa
\def \nota {Trabalho de portfólio apresentado como requisito parcila para a obtenção de pontos para a média semestral.
}

% Professor
\def \prof {Tutor Vinicius Camargo Prattes
}